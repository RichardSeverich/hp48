 ...
 */
public class SevenButtonModelTest {
  ...
  /**
   * This test is to verify that the seven button works correctly.
   */
  @Test
  public void test_firstFunction_WhenTheUserPressSevenButton() {

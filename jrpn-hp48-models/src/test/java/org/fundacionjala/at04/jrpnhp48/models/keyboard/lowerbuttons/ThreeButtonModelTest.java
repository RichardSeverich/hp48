 ...
 */
public class ThreeButtonModelTest {
  ...
  /**
   * This test is to verify that the three button works correctly.
   */
  @Test
  public void test_firstFunction_WhenTheUserPressThreeButton() {
